...
def main():
    ...
    try:
        ...
        raise RuntimeError(f"Could not initialize audio device: {e}") from e
    bounce = load_sound("bounce.mp3")
    startSound = load_sound("start.mp3")
    lose = load_sound("lose.mp3")
    win = load_sound("win.mp3")
    score1 = load_image("score1.png")
    score2 = load_image("score2.png")
